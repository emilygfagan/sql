/* HR Practice SQL Code
Assignment for Data Analytics Bootcamp */


USE hr; -- telling MySQL to use the hr database
...
/* Task 5: Extract the employee IDs, first names, department names, and total experience of all those employees 
who have completed at least 25 years in the organization. */

SELECT employees.employee_id AS 'Employee ID', employees.first_name AS 'First Name', departments.department_name AS 'Department', 
  TIMESTAMPDIFF(year, employees.hire_date, '2023-07-26') AS 'Number of Years'
  -- selecting appropriate columns and naming them for aesthetics
FROM employees INNER JOIN departments ON employees.department_id = departments.department_id
  -- joining employees and departments tables
